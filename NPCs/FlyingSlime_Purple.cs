...
namespace RaidersMod.NPCs
{
    public class FlyingSlime_Purple : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            {
                npc.velocity = Vector2.Normalize(player.Center - npc.Center) * 4.25f;  
    ...
    {
        Item.NewItem(npc.position,ModContent.ItemType<Items.craftingMaterials.SlimeFeather>(),Main.rand.Next(3,9));
